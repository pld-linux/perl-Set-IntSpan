...
Source:		ftp://ftp.perl.org/pub/CPAN/modules/by-module/Set/Set-IntSpan-%{version}.tar.gz
...
(
  cd $RPM_BUILD_ROOT%{perl_sitearch}/auto/Set/IntSpan
...
%{perl_sitearch}/auto/Set/IntSpan
